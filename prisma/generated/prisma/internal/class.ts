...
/**
   ...
   * `prisma.onboardingStepLog`: Exposes CRUD operations for the **OnboardingStepLog** model.
    ...
    * ```
    */
  get onboardingStepLog(): Prisma.OnboardingStepLogDelegate<ExtArgs, { omit: OmitOpts }>;

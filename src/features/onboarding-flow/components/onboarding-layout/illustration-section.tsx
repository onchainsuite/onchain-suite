...
export function IllustrationSection({ currentStep }: IllustrationSectionProps) {
  ...
  return (
    <div className="hidden bg-gradient-to-br from-amber-100 to-amber-200 lg:flex lg:items-center lg:justify-center lg:p-16 dark:from-amber-900/20 dark:to-amber-800/20">

  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-card/80 backdrop-blur-md",
        className
      )}
    >
      {children}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-card px-4 py-8 shadow-[0_0_24px_rgba(34,42,53,0.06),0_1px_1px_rgba(0,0,0,0.05),0_0_0_1px_rgba(34,42,53,0.04),0_0_4px_rgba(34,42,53,0.08),0_16px_68px_rgba(47,48,55,0.05),0_1px_0_rgba(255,255,255,0.1)_inset]",
            className
          )}
        >
          {children}
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="font-medium text-foreground">Onchain Suite</span>
    </Link>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary:
      "bg-transparent shadow-none text-foreground hover:text-muted-foreground",
    dark: "bg-secondary text-secondary-foreground shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
    gradient:
